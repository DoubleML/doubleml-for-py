...
@pytest.mark.parametrize('ml_param_space, msg', [
...
@pytest.mark.parametrize('scoring_methods, exc, msg', [
...
@pytest.mark.parametrize('cv, msg', [
...
@pytest.mark.parametrize('set_as_params, msg', [
...
@pytest.mark.parametrize('return_tune_res, msg', [
...
@pytest.mark.parametrize('optuna_settings, msg', [
