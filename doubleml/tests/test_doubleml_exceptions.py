...
dml_data_pliv = make_pliv_CHS2015(n_obs=300, dim_z=1)
dml_pliv = DoubleMLPLIV(dml_data_pliv, ml_l, ml_m, ml_r)

dml_data_irm = make_irm_data(n_obs=300)
dml_data_iivm = make_iivm_data(n_obs=300)
dml_cluster_data_pliv = make_pliv_multiway_cluster_CKMS2021(N=10, M=10)
(x, y, d, z) = make_iivm_data(n_obs=300, return_type="array")
y[y > 0] = 1
y[y < 0] = 0
