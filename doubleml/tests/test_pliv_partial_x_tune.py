...
@pytest.fixture(scope='module')
def dml_pliv_partial_x_fixture(generate_data_pliv_partialX, idx, learner_g, learner_m, learner_r, score, dml_procedure, tune_on_folds):
    ...
    if tune_on_folds:
        ...
        g_hat, r_hat, r_hat_tilde = fit_nuisance_pliv_partial_x(y, X, d, z,
                                                                clone(learner_m), clone(learner_g), clone(learner_r),
                                                                smpls,
                                                                g_params * n_folds, m_params_per_fold, r_params * n_folds)
